...
VALUES (1, 1, 1, 0, 1, 1), (2, 1, 2, 0, 1, 1), (3, 1, 3, 0, 1, 1), (4, 1, 4, 0, 1, 1), (5, 1, 5, 0, 1, 1),
...
VALUES (1, 1, 'SKU-MC-001', '抹茶クッキー-小', 298.00, 'JPY', 180.00, 299.00, NOW(), '4901000000011', 0.10, 0.30, 1, 0, 1, 1),
...
VALUES (1, 'CUST-001', '山田商事', 'Yamada Trading', '山田太郎', '0311111111', 'yamada@test.com', 'JP', '東京', '港区1-1-1',
        1, 2, 2, '主要顧客', 1, 0, 1, 1),
...
INSERT INTO t_stock_order(id, order_no, order_type, warehouse_id, source_type, source_id, total_qty, stock_type_id,
                          ...
                          approver_name, approve_time, biz_date, version, finish_time, deleted, created_by, updated_by)
VALUES (1, 'SO-20260507-001', 2, 1, 3, 1, 30, 1, 2, 2, 'sales01', 3, 'warehouse01', 'REQ連動', 1, 'admin', NOW(), NOW(), 1, NOW(), 0, 3, 1),
       (2, 'SO-20260507-002', 1, 2, 4, NULL, 50, 1, 2, 3, 'warehouse01', 3, 'warehouse01', '手動入庫', 1, 'admin', NOW(), NOW(), 1, NOW(), 0, 3, 1);
...
VALUES (1, 1, '抹茶クッキー', 'Matcha Cookie', 1, 'SKU-MC-001', 280.00, 298.00, 'JPY', 1.0000, NOW(), 1, 'admin', 0, 1, 1),
...
VALUES (1, 1, 'admin', 'schema', 'GET', 'GET', '/api/schema/menu', '127.0.0.1', '{}', '{"ok":true}', 1, NULL, 12, 0, 1, 1),
