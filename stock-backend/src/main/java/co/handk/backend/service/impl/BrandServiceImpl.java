...
public class BrandServiceImpl extends ServiceImpl<BrandMapper, Brand> implements BrandService {
    ...
    public Boolean delete(Long id) {
        ...
        return this.lambdaUpdate().eq(Brand::getId, id).set(Brand::getDeleted, DeleteEnum.DELETED.getCode()).update();
    }
    ...
    public PageResult<BrandVO> pageQuery(BrandQueryDTO query) {
        ...
        wrapper.eq(Brand::getDeleted, DeleteEnum.UNDELETED.getCode())
